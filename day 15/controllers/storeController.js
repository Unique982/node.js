...
exports.getIndex =(req,res,next)=>{
  ...
  Home.find().then(registerHome =>{
   res.render('store/index',{registerHome:registerHome, pageTitle:'Home',isLoggedIn:req.isLoggedIn})
  });
 }
...
exports.getHomesList =(req,res,next)=>{
  Home.find().then(registerHome =>{
  res.render('store/home-list',{registerHome:registerHome, pageTitle:'Home List',isLoggedIn:req.isLoggedIn})
});
}
...
exports.getBooking =(req,res,next)=>{
  Home.find((registerHome) => 
   res.render('store/booking',{registerHome:registerHome, pageTitle:'Booking Page',isLoggedIn:req.isLoggedIn})
 );
 }
// getFavouriteList
exports.getFavouriteList =(req,res,next)=>{
  ...
  .then((favourites) => {
    const favouritesHome = favourites.map((fav) => fav.houseId);
      ...
      res.render('store/favourites-list',{favouritesHome:favouritesHome, pageTitle:'Favourites Page',isLoggedIn:req.isLoggedIn});
   });
...
exports.getHomeDetails =(req,res,next)=>{
  ...
  Home.findById(homeId).then(home=>{
    ...
    res.render('store/home-details',
      {home:home,pageTitle:'Home Datails Page',isLoggedIn:req.isLoggedIn}
    );
  }
  });
